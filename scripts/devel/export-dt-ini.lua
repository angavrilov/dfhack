...
vector('fortress_entity',globals,'ui','main','fortress_entity')
...
vector('active_sites_vector',df.global.world.world_data,'active_site')
offset('world_site_type',df.global.world.world_data,'next_site_id')
